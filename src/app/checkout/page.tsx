...
export default function CheckoutPage({ searchParams }: { searchParams: Record<string, string> }) {
  ...
  const size = searchParams.size || "L";
  const price = parseFloat(searchParams.price || "24.78");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setOrderStatus({ ok: true, msg: "¡Orden enviada exitosamente a POPCustoms!" });
      } else {
        setOrderStatus({
          ok: false,
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-14 grid grid-cols-1 lg:grid-cols-5 gap-12">
        ...
        <div className="lg:col-span-2 order-2 lg:order-1">
          ...
          <div className="mt-6 space-y-2 text-xs text-gray-500">
            ...
            <div className="flex items-center gap-2"><Package className="w-3.5 h-3.5 text-[#00E5FF]" /> Producido y enviado por POPCustoms</div>
          </div>
        </div>
        ...
        <div className="lg:col-span-3 order-1 lg:order-2">
          ...
          {orderNumber ? (
            ...
            >
              ...
              <p className="text-gray-400 text-sm mb-4">Tu orden ha sido enviada a POPCustoms para producción.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <p className="text-xs text-gray-600 text-center">Al confirmar, tu orden se envía directamente a POPCustoms para producción y despacho.</p>
            </form>
          )}
        </div>
      </div>
